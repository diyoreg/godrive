...
async function startServer() {
    try {
        // Запускаем сервер на 0.0.0.0 для Railway СРАЗУ
        ...
        // Инициализация БД в фоновом режиме (не блокирует запуск)
        console.log('🔧 Запуск фоновой инициализации базы данных...');
        ...
        initializer.initializeDatabase()
            ...
            .catch(error => {
                console.error('⚠️  Ошибка инициализации БД (сервер продолжит работу):', error.message);
            });
